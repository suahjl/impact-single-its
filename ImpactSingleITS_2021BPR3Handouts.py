...
fig_impact.update_layout(
    title='Single Entity Interrupted Time Series: ' +
          'Impact of BPR3 Cash Handouts on Daily Transactions',
...
# Export chart
fig_impact.write_html('Output/ImpactSingleITS_2021BPR3Handouts_ImpactPlot.html')
fig_impact.write_image('Output/ImpactSingleITS_2021BPR3Handouts_ImpactPlot.png')
telsendimg(conf=tel_config,
           path='Output/ImpactSingleITS_2021BPR3Handouts_ImpactPlot.png',
...
fig_impact_cumul_myr.update_layout(
    title='Single Entity Interrupted Time Series: ' +
          'Cumulative MYR Impact of BPR3 Cash Handouts on Daily Transactions',
    yaxis_title='MYR',
    plot_bgcolor='white',
    hovermode='x',
    font=dict(color='black', size=12),
...
# Export chart
fig_impact_cumul_myr.write_html('Output/ImpactSingleITS_2021BPR3Handouts_CumulMYRImpactPlot.html')
fig_impact_cumul_myr.write_image('Output/ImpactSingleITS_2021BPR3Handouts_CumulMYRImpactPlot.png')
telsendimg(conf=tel_config,
           path='Output/ImpactSingleITS_2021BPR3Handouts_CumulMYRImpactPlot.png',
           cap='Single Entity Interrupted Time Series: ' +
               'Cumulative MYR Impact of BPR3 Cash Handouts on Daily Transactions')
...
df_fcast_myr_end.to_csv('multiplier_2021BPR3Handouts.txt', index=False, sep='|')
...
fig_multiplier.update_layout(
    title='Single Entity Interrupted Time Series: ' +
          'Spending Multiplier of BPR3 Cash Handouts on Daily Transactions (Cumulative Impact / Total Handouts)',
...
# Export chart
fig_multiplier.write_html('Output/ImpactSingleITS_2021BPR3Handouts_MultiplierPlot.html')
fig_multiplier.write_image('Output/ImpactSingleITS_2021BPR3Handouts_MultiplierPlot.png')
telsendimg(conf=tel_config,
           path='Output/ImpactSingleITS_2021BPR3Handouts_MultiplierPlot.png',
           cap='Single Entity Interrupted Time Series: ' +
               'Spending Multiplier of BPR3 Cash Handouts on Daily Transactions (Cumulative Impact / Total Handouts)')
...
telsendimg(conf=tel_config,
           path='Output/ImpactSingleITS_2021BPR3Handouts_ObsCFactPlot.png',
           cap='Single Entity Interrupted Time Series: ' +
               'Observed and Counterfactual Daily Transactions (with 95% CIs)')

fig_comp_withpred.write_html('Output/ImpactSingleITS_2021BPR3Handouts_ObsCFactPredPlot.html')
fig_comp_withpred.write_image('Output/ImpactSingleITS_2021BPR3Handouts_ObsCFactPredPlot.png')
telsendimg(conf=tel_config,
           path='Output/ImpactSingleITS_2021BPR3Handouts_ObsCFactPredPlot.png',
           cap='Single Entity Interrupted Time Series: ' +
