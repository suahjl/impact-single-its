...
df = pd.read_excel(latest_transactions, sheet_name='daily_raw')  # seasonally adjusted
...
if run_charts:
    ...
    fig_level = multiEventTSplot(
        ...
        maxrows=4,
        maxcols=4,
        main_title='Daily Transactions and Mobility During the BPR3 Cash Handouts',
        y_title='100 = (1 Jan 2020; or Jan-Feb 2020) ',
        output_name='Output/ImpactSingleITS_2021BPR3Handouts_TSPlots_NSA_Level'
    )
    telsendimg(conf=tel_config,
               path='Output/ImpactSingleITS_2021BPR3Handouts_TSPlots_NSA_Level.png',
               cap='Daily Transactions During the BPR3 Cash Handouts')
    # Log-difference
    fig_logdiff = multiEventTSplot(
        ...
        maxrows=4,
        maxcols=4,
        main_title='Log Difference of Daily Transactions and Mobility During the BPR3 Cash Handouts',
        y_title='Growth / 100',
        output_name='Output/ImpactSingleITS_2021BPR3Handouts_TSPlots_NSA_LogDiff'
    )
    telsendimg(conf=tel_config,
               path='Output/ImpactSingleITS_2021BPR3Handouts_TSPlots_NSA_LogDiff.png',
               cap='Log Difference of Daily Transactions During the BPR3 Cash Handouts')
