...
if run_charts:
    ...
    fig_level = multiEventTSplot(
        ...
        output_name='Output/ImpactSingleITS_2020CMCOHandouts_TSPlots_Level'
    )
    telsendimg(conf=tel_config,
               path='Output/ImpactSingleITS_2020CMCOHandouts_TSPlots_Level.png',
    ...
    fig_logdiff = multiEventTSplot(
        ...
        y_title='Growth / 100',
        output_name='Output/ImpactSingleITS_2020CMCOHandouts_TSPlots_LogDiff'
    )
    telsendimg(conf=tel_config,
               path='Output/ImpactSingleITS_2020CMCOHandouts_TSPlots_LogDiff.png',
