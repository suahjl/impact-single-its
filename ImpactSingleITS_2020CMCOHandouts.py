...
run_prechecks = True
show_ci = True
quantum_handout_myr = 11500000000 + 1900000000
# 11500000000  # MYR11.5 billion (7th LAKSANA report) https://www.mof.gov.my/portal/pdf/laporan-laksana/laksana-07/
# 3608000000  # MYR3.608 billion (only May 2020)
# 8528000000  # MYR8.528 billion (inc April 2020)
# + 1900000000 # MYR1.9 billion (iLestari in May)
...
# Event onsets
df.loc[df.index == date(2020, 4, 6), 'handout_p1_b40'] = 1
df.loc[df.index == date(2020, 4, 13), 'handout_p1_m40'] = 1
df.loc[df.index == date(2020, 5, 4), 'handout_p2'] = 1  # actual disbursement
...
T_lb = date(2020, 3, 25)  # Need to consider blanket moratorium
...
if run_prechecks:
    ...
    dfi.export(urtest_consol, 'Output/ImpactSingleITS_2020CMCOHandouts_URoot.png')
    telsendimg(conf=tel_config,
               path='Output/ImpactSingleITS_2020CMCOHandouts_URoot.png',
               cap='Unit root tests')
...
list_loglevels_exog = ['mob_retl_ln', 'mob_groc_ln']  # 'mob_retgro_ln'
list_logdiff_exog = ['mob_retl_ln_d', 'mob_groc_ln_d']  # 'mob_retgro_ln_d'
...
# Export chart
fig_impact.write_html('Output/ImpactSingleITS_2020CMCOHandouts_ImpactPlot.html')
fig_impact.write_image('Output/ImpactSingleITS_2020CMCOHandouts_ImpactPlot.png')
telsendimg(conf=tel_config,
           path='Output/ImpactSingleITS_2020CMCOHandouts_ImpactPlot.png',
...
# Export chart
fig_impact_cumul_myr.write_html('Output/ImpactSingleITS_2020CMCOHandouts_CumulMYRImpactPlot.html')
fig_impact_cumul_myr.write_image('Output/ImpactSingleITS_2020CMCOHandouts_CumulMYRImpactPlot.png')
telsendimg(conf=tel_config,
           path='Output/ImpactSingleITS_2020CMCOHandouts_CumulMYRImpactPlot.png',
           cap='Single Entity Interrupted Time Series: ' +
               'Cumulative MYR Impact of CMCO Cash Handouts on Daily Transactions')
...
df_fcast_myr_end.to_csv('multiplier_2020CMCOHandouts.txt', index=False, sep='|')
...
# Export chart
fig_multiplier.write_html('Output/ImpactSingleITS_2020CMCOHandouts_MultiplierPlot.html')
fig_multiplier.write_image('Output/ImpactSingleITS_2020CMCOHandouts_MultiplierPlot.png')
telsendimg(conf=tel_config,
           path='Output/ImpactSingleITS_2020CMCOHandouts_MultiplierPlot.png',
           cap='Single Entity Interrupted Time Series: ' +
               'Spending Multiplier of CMCO Cash Handouts on Daily Transactions (Cumulative Impact / Total Handouts)')
...
# Export Charts
fig_comp.write_html('Output/ImpactSingleITS_2020CMCOHandouts_ObsCFactPlot.html')
fig_comp.write_image('Output/ImpactSingleITS_2020CMCOHandouts_ObsCFactPlot.png')
telsendimg(conf=tel_config,
           path='Output/ImpactSingleITS_2020CMCOHandouts_ObsCFactPlot.png',
           cap='Single Entity Interrupted Time Series: ' +
               'Observed and Counterfactual Daily Transactions (with 95% CIs)')

fig_comp_withpred.write_html('Output/ImpactSingleITS_2020CMCOHandouts_ObsCFactPredPlot.html')
fig_comp_withpred.write_image('Output/ImpactSingleITS_2020CMCOHandouts_ObsCFactPredPlot.png')
telsendimg(conf=tel_config,
           path='Output/ImpactSingleITS_2020CMCOHandouts_ObsCFactPredPlot.png',
           cap='Single Entity Interrupted Time Series: ' +
               'Observed, Counterfactual, and Pre-Event Predicted Daily Transactions')
...
# Export chart
fig_impact_sens.write_html('Output/ImpactSingleITS_2020CMCOHandouts_ImpactPlot_Sensitivity.html')
fig_impact_sens.write_image('Output/ImpactSingleITS_2020CMCOHandouts_ImpactPlot_Sensitivity.png')
telsendimg(conf=tel_config,
           path='Output/ImpactSingleITS_2020CMCOHandouts_ImpactPlot_Sensitivity.png',
...
# Export chart
fig_impact_cumul_myr_sens.write_html('Output/ImpactSingleITS_2020CMCOHandouts_CumulMYRImpactPlot_Sensitivity.html')
fig_impact_cumul_myr_sens.write_image('Output/ImpactSingleITS_2020CMCOHandouts_CumulMYRImpactPlot_Sensitivity.png')
telsendimg(conf=tel_config,
           path='Output/ImpactSingleITS_2020CMCOHandouts_CumulMYRImpactPlot_Sensitivity.png',
           cap='(Sensitivity Check) Single Entity Interrupted Time Series: ' +
               'Cumulative MYR Impact of CMCO Cash Handouts on Daily Transactions')
...
# Export chart
fig_multiplier_sens.write_html('Output/ImpactSingleITS_2020CMCOHandouts_MultiplierPlot_Sensitivity.html')
fig_multiplier_sens.write_image('Output/ImpactSingleITS_2020CMCOHandouts_MultiplierPlot_Sensitivity.png')
telsendimg(conf=tel_config,
           path='Output/ImpactSingleITS_2020CMCOHandouts_MultiplierPlot_Sensitivity.png',
           cap='(Sensitivity Check) Single Entity Interrupted Time Series: ' +
               'Spending Multiplier of CMCO Cash Handouts on Daily Transactions (Cumulative Impact / Total Handouts)')
...
# Export charts
fig_comp_sens.write_html('Output/ImpactSingleITS_2020CMCOHandouts_ObsCFactPlot_Sensitivity.html')
fig_comp_sens.write_image('Output/ImpactSingleITS_2020CMCOHandouts_ObsCFactPlot_Sensitivity.png')
telsendimg(conf=tel_config,
           path='Output/ImpactSingleITS_2020CMCOHandouts_ObsCFactPlot_Sensitivity.png',
           cap='(Sensitivity Check) Single Entity Interrupted Time Series: ' +
               'Observed and Counterfactual Daily Transactions (with 95% CIs)')

fig_comp_withpred_sens.write_html('Output/ImpactSingleITS_2020CMCOHandouts_ObsCFactPredPlot_Sensitivity.html')
fig_comp_withpred_sens.write_image('Output/ImpactSingleITS_2020CMCOHandouts_ObsCFactPredPlot_Sensitivity.png')
telsendimg(conf=tel_config,
           path='Output/ImpactSingleITS_2020CMCOHandouts_ObsCFactPredPlot_Sensitivity.png',
           cap='(Sensitivity Check) Single Entity Interrupted Time Series: ' +
               'Observed, Counterfactual, and Pre-Event Predicted Daily Transactions')
