...
for state in tqdm(list(df_full.columns)):
    ...
    if run_prechecks:
        ...
        dfi.export(urtest_consol, 'Output/ImpactSingleITS_2020CMCOHandouts_URoot_' + state + '.png')
    ...
    # Export chart
    fig_impact.write_html('Output/ImpactSingleITS_2020CMCOHandouts_ImpactPlot_' + state + '.html')
    fig_impact.write_image('Output/ImpactSingleITS_2020CMCOHandouts_ImpactPlot_' + state + '.png')
    ...
    # Export chart
    fig_impact_cumul_myr.write_html('Output/ImpactSingleITS_2020CMCOHandouts_CumulMYRImpactPlot_' + state + '.html')
    fig_impact_cumul_myr.write_image('Output/ImpactSingleITS_2020CMCOHandouts_CumulMYRImpactPlot_' + state + '.png')
    ...
    # Export Charts
    fig_comp.write_html('Output/ImpactSingleITS_2020CMCOHandouts_ObsCFactPlot_' + state + '.html')
    fig_comp.write_image('Output/ImpactSingleITS_2020CMCOHandouts_ObsCFactPlot_' + state + '.png')

    fig_comp_withpred.write_html('Output/ImpactSingleITS_2020CMCOHandouts_ObsCFactPredPlot_' + state + '.html')
    fig_comp_withpred.write_image('Output/ImpactSingleITS_2020CMCOHandouts_ObsCFactPredPlot_' + state + '.png')
...
for chart_type in tqdm(['ImpactSingleITS_2020CMCOHandouts_ImpactPlot_',
                        'ImpactSingleITS_2020CMCOHandouts_CumulMYRImpactPlot_',
                        'ImpactSingleITS_2020CMCOHandouts_ObsCFactPredPlot_']):
